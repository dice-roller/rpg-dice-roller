  ...
  describe('Basic rolls', () => {
    test('roll `2d7 + (5d4 * 2)`', () => {
      ...
      jest.spyOn(StandardDice.prototype, 'roll')
        .mockImplementationOnce(() => rolls[0] as RollResults)
        .mockImplementationOnce(() => rolls[1] as RollResults);
      const roll = roller.roll('2d7 + (5d4 * 2)') as DiceRoll;
    ...
    test('roll `floor(2.56 * d7)`', () => {
      ...
      const roll = roller.roll('floor(2.56 * d7)') as DiceRoll;
    ...
    test('roll `ceil(2.56 * d7)`', () => {
      ...
      jest.spyOn(StandardDice.prototype, 'roll')
        .mockImplementationOnce(() => rolls);
      const roll = roller.roll('ceil(2.56 * d7)') as DiceRoll;
    ...
    test('roll `max(2 * (d7/2), 1d7)`', () => {
      ...
      const roll = roller.roll('max(2 * (d7/2), 1d7)') as DiceRoll;
    ...
    test('roll `min(2 * (d7/2), 1d7)`', () => {
      ...
      jest.spyOn(StandardDice.prototype, 'roll')
        .mockImplementationOnce(() => rollsFirst)
        .mockImplementationOnce(() => rollsSecond);
      const roll = roller.roll('min(2 * (d7/2), 1d7)') as DiceRoll;
    ...
    test('roll `3d6cs>3cf<3`', () => {
      ...
      const roll = roller.roll('3d6cs>3cf<3') as DiceRoll;
    ...
    test('roll `4d6sd`', () => {
      jest.spyOn(StandardDice.prototype, 'rollOnce')
        ...
        .mockImplementationOnce(() => new RollResult(5))
        .mockImplementationOnce(() => new RollResult(1));
      const roll = roller.roll('4d6sd') as DiceRoll;
    ...
    test('roll `2d6r<=4`', () => {
      jest.spyOn(StandardDice.prototype, 'rollOnce')
        ...
        // re-roll
        .mockImplementationOnce(() => new RollResult(6));
      const roll = roller.roll('2d6r<=4') as DiceRoll;
    ...
    test('roll `6d10>=8!>=9`', () => {
      jest.spyOn(StandardDice.prototype, 'rollOnce')
        ...
        // explode
        .mockImplementationOnce(() => new RollResult(6));
      const roll = roller.roll('6d10>=8!>=9') as DiceRoll;
    ...
    test('roll `6d10!>=9>=8`', () => {
      jest.spyOn(StandardDice.prototype, 'rollOnce')
        ...
        // explode
        .mockImplementationOnce(() => new RollResult(6));
      const roll = roller.roll('6d10!>=9>=8') as DiceRoll;
    ...
    test('roll `2d10!<>8`', () => {
      jest.spyOn(StandardDice.prototype, 'rollOnce')
        ...
        .mockImplementationOnce(() => new RollResult(8))
        .mockImplementationOnce(() => new RollResult(8));
      const roll = roller.roll('2d10!<>8') as DiceRoll;
    ...
    test('roll `(4d10^7)*6d(3*2)`', () => {
      jest.spyOn(StandardDice.prototype, 'rollOnce')
        ...
        .mockImplementationOnce(() => new RollResult(1))
        .mockImplementationOnce(() => new RollResult(3));
      const roll = roller.roll('(4d10^7)*6d(3*2)') as DiceRoll;
    ...
    test('roll `5d6%2d20`', () => {
      ...
      const roll = roller.roll('5d6%2d20') as DiceRoll;
    ...
    test('roll `6d10min3max6', () => {
      jest.spyOn(StandardDice.prototype, 'rollOnce')
        ...
        .mockImplementationOnce(() => new RollResult(1))
        .mockImplementationOnce(() => new RollResult(9));
      const roll = roller.roll('6d10min3max6') as DiceRoll;
    ...
    test('roll `1d20+1.45', () => {
      ...
      jest.spyOn(StandardDice.prototype, 'roll')
        .mockImplementationOnce(() => rolls);
      const roll = roller.roll('1d20+1.45') as DiceRoll;
    ...
    test('roll `1d20*0.20', () => {
      ...
      jest.spyOn(StandardDice.prototype, 'roll')
        .mockImplementationOnce(() => rolls);
      const roll = roller.roll('1d20*0.20') as DiceRoll;
    ...
    test('roll `1d20/6.02', () => {
      ...
      jest.spyOn(StandardDice.prototype, 'roll')
        .mockImplementationOnce(() => rolls);
      const roll = roller.roll('1d20/6.02') as DiceRoll;
    ...
    test('roll `1d20+0', () => {
      ...
      jest.spyOn(StandardDice.prototype, 'roll')
        .mockImplementationOnce(() => rolls);
      const roll = roller.roll('1d20+0') as DiceRoll;
    ...
    test('roll `2d6u`', () => {
      jest.spyOn(StandardDice.prototype, 'rollOnce')
        ...
        .mockImplementationOnce(() => new RollResult(4))
        .mockImplementationOnce(() => new RollResult(6));
      const roll = roller.roll('2d6u') as DiceRoll;
    ...
    test('roll `2d6uo`', () => {
      jest.spyOn(StandardDice.prototype, 'rollOnce')
        ...
        .mockImplementationOnce(() => new RollResult(4))
        .mockImplementationOnce(() => new RollResult(8));
      const roll = roller.roll('2d6uo') as DiceRoll;
